...
import {
  ...
  EhrFeatureList,
} from "../components/shared/EhrComingSoon";
...
export function SynchronizerPanel({
  ...
  const { enabled: ehrLive, message: ehrMessage, features: ehrFeatures } = useEhrFeatures();
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-white rounded-xl border border-border p-5 space-y-6">
        {!ehrLive && <EhrComingSoonBanner message={ehrMessage} />}

        <EhrComingSoonSection locked={!ehrLive} message={ehrMessage}>
          ...
          {step1Done && (
            <section className="space-y-3 border-t border-gray-100 pt-5">
              ...
              <button
                type="button"
                disabled={busy || fields.length === 0 || !ehrLive}
          ...
          {step3Done && (
            <section className="space-y-3 border-t border-gray-100 pt-5">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  type="button"
                  disabled={busy || !step4Done || !ehrLive}
                  onClick={runSync}
                  className="px-4 py-2 bg-teal-500 text-white text-sm font-semibold rounded-lg disabled:opacity-60"
                >
      ...
      <EhrFeatureList features={ehrFeatures} />
    </div>
  );
}
