...
export function OnlineBookingLinksView({
  ...
  const thankYouUrl = buildBookingThankYouUrl(practice?.name);

  function openPreview() {
    window.open(basicLink, "_blank", "noopener,noreferrer");
  }

  function openBookNowPreview() {
    window.open(conversionLink, "_blank", "noopener,noreferrer");
  }

  function useThankYouUrl() {
    setRedirectUrl(thankYouUrl);
  }
          ...
          <div className="pt-4 border-t border-gray-100">
            ...
            <div className="mb-3">
              ...
              <button
                ...
                title="Opens your booking page"
              >
                Book Now
              </button>
              <p className="text-xs text-gray-400 mt-1.5">Click to open the booking page in a new tab.</p>
            </div>
          ...
          {isAdmin && (
            <div className="pt-4 border-t border-gray-100 space-y-2">
              ...
              <p className="text-xs text-gray-500">
                After patients complete a booking, send them to a thank-you page (or your own website).
              </p>
              <div className="rounded-lg border border-teal-100 bg-teal-50/50 px-3.5 py-3 space-y-2">
                <p className="text-xs font-semibold text-teal-900">Built-in thank-you page</p>
                <input readOnly value={thankYouUrl} className={`${inputCls} text-xs`} />
                <div className="flex flex-wrap gap-2">
                  <button
                    type="button"
                    onClick={useThankYouUrl}
                  ...
                  <button
                    type="button"
                    onClick={() => copy(thankYouUrl, "Thank-you URL")}
                    className="px-3 py-1.5 border border-teal-200 text-teal-800 text-xs font-semibold rounded-lg hover:bg-white"
                  >
                    Copy URL
                  </button>
                  <a
                    ...
                    className="inline-flex items-center gap-1 px-3 py-1.5 border border-teal-200 text-teal-800 text-xs font-semibold rounded-lg hover:bg-white"
                  >
